  ...
  return (
    <>
      <div className="hero">
        ...
        <h1>{SITE_NAME}</h1>
        <p>
          ガジュマルは、クワ科イチジク属の常緑高木です。育て方や品種の見分け方に加えて、絞め殺しの木としての生態、ASPCAの情報にもとづくペットへの注意、沖縄のキジムナー伝承までを、信頼できる出典で確かめながらまとめています。
        </p>
      </div>
...
const ABOUT_CONTENT = `本サイト「${SITE_NAME}」は、観葉植物のガジュマルに興味を持った人が、植物としての姿から育て方、ペットとの安全、沖縄の文化までをひととおり確かめられるようにまとめたものです。
